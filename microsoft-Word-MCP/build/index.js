...
import { createDocument, addParagraph, addHeading, formatText, addList, addTable, insertImage, addHyperlink, setDocumentProperties, saveDocument, loadDocument, mergeDocuments, addTableOfContents, parseMarkdown, parseJsonStructure } from './word-utils.js';
class WordMCPServer {
    server;
    documentState = null;
    constructor() {
            ...
            try {
                switch (name) {
                    case 'create_document':
                        this.documentState = createDocument(args);
                        return {
                    ...
                    case 'add_paragraph':
                        ...
                        addParagraph(this.documentState, args);
                        return {
                    ...
                    case 'add_heading':
                        ...
                        addHeading(this.documentState, args);
                        return {
                    ...
                    case 'format_text':
                        ...
                        const formattedText = formatText(this.documentState, args);
                        return {
                    ...
                    case 'add_list':
                        ...
                        addList(this.documentState, args);
                        return {
                    ...
                    case 'add_table':
                        ...
                        addTable(this.documentState, args);
                        return {
                    ...
                    case 'insert_image':
                        ...
                        insertImage(this.documentState, args);
                        return {
                    ...
                    case 'add_hyperlink':
                        ...
                        addHyperlink(this.documentState, args);
                        return {
                    ...
                    case 'set_document_properties':
                        ...
                        setDocumentProperties(this.documentState, args);
                        return {
                    ...
                    case 'save_document':
                        ...
                        await saveDocument(this.documentState, args.path);
                        return {
                            content: [{ type: 'text', text: `Document saved to ${args.path}` }],
                        };
                    case 'load_document':
                        if (!args?.path) {
                            throw new Error('Path is required for load_document');
                        }
                        this.documentState = await loadDocument(args.path);
                        return {
                            content: [{ type: 'text', text: `Document loaded from ${args.path}` }],
                        };
                    case 'merge_documents':
                        ...
                        await mergeDocuments(args.documentPaths, args.outputPath);
                        return {
                            content: [{ type: 'text', text: `Documents merged to ${args.outputPath}` }],
                        };
                    case 'add_table_of_contents':
                        if (!this.documentState) {
                            throw new Error('No document created. Call create_document first.');
                        }
                        addTableOfContents(this.documentState, args);
                        return {
                    ...
                    case 'parse_markdown':
                        ...
                        this.documentState = parseMarkdown(args.markdown);
                        return {
                    ...
                    case 'parse_json_structure':
                        ...
                        this.documentState = parseJsonStructure(args.structure);
                        return {
